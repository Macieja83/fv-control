...
const FAQ: Array<{ q: string; a: string }> = [
  ...
  },
  {
    ...
    a: 'W MVP PRO jest opłacany jednorazowo na 30 dni przez BLIK albo kartę. Nie ma automatycznego odnowienia — po końcu okresu możesz opłacić kolejny miesiąc.',
  },
  {
    q: 'Jakie metody płatności obsługujecie?',
    a: 'Plan PRO w MVP przyjmuje BLIK oraz kartę. Apple Pay i Google Pay pokazują się w Stripe Checkout, jeśli Twoje urządzenie i przeglądarka je obsługują. Płatności obsługuje Stripe — PCI-DSS Level 1.',
  },
  {
        ...
        <section className="pricing-plans">
          <div className="section-inner">
            ...
            <p className="pricing-plans__note">
              Wszystkie ceny brutto. MVP: jednorazowa płatność BLIK albo kartą (dostęp na 30 dni).
            ...
            <div className="compare-table-wrap">
              <table className="compare-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Płatność BLIK / karta</td>
                    <td className="td-highlight">✓ BLIK + karta</td>
                    <td>Karta + przelew</td>
                    <td>Karta + przelew</td>
                  </tr>
                  <tr>
